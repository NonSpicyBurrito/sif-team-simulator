...
export function tickSkills(live: Live, time: number, triggers: [number][]) {
    ...
    const skillChanceMultiplier = (1 + live.context.skillChanceBonus) * (1 + live.sruState.value)
    ...
    live.lastSkill = live.tempLastSkill || (live.purgeLastSkill ? undefined : live.lastSkill)
